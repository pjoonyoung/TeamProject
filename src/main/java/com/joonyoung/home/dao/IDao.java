...
public interface IDao {
	...
	public ArrayList<QBoardDto> mySearchTitleList(String qid, String searchKey);//전체 게시글 제목으로검색
	public ArrayList<QBoardDto> mySearchContentList(String qid, String searchKey);//전체 게시글 내용으로검색
	public ArrayList<QBoardDto> mySearchWriterList(String qid, String searchKey);//전체 게시글 아이디(글쓴이)로검색
