...
<%@ include file="include/header.jsp" %>
	...
	<div id="container">
		...
		<!-- 로그인 페이지 타이틀 -->
		<div id="loginBoxTitle">비밀번호찾기</div>
		
	    <!-- 아이디, 비번, 버튼 박스 -->
	    <div id="inputBox">
	    	<form action="pwFindOk" method="post" name="pwfind_frm">
				...
				<div class="button-login-box" >
					<input type="button" class="btn btn-primary btn-xs" style="width:100%" value="찾기" onclick="pwfindCheck()">
				</div>
	        </form>
        </div>
       	<div class="find_wrap font-monospace">
			...
			<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/pwfind.js"></script>
		</div>
	</div>	
</div>			
<!-- 하단 시작 -->
